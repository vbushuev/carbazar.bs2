...
class Gibdd{
    ...
    //     $http = new Http();
    //     $url = "http://www.gibdd.ru/check/auto/#".$d["vin"];
    ...
    //     $res = $http->fetch("http://check.gibdd.ru/proxy/check/auto/history","POST",[
    //         "vin" => $d["vin"],
    //         "captchaWord"=>$word,
    //         "checkType"=>"history"
    //     ]);
    ...
    //     $word = $captcha->get($d);
    //     // checkdata http://check.gibdd.ru/proxy/check/auto/history
    //     $res = $http->fetch("http://check.gibdd.ru/proxy/check/auto/dtp","POST",[
    //         "vin" => $d["vin"],
    //         "captchaWord"=>$word,
    //         "checkType"=>"aiusdtp"
    //     ]);
